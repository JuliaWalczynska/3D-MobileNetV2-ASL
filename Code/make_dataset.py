'''
Creating dataset with videos.
Code from WLASL repository, slightly modified to better suit my needs
...
def make_dataset(data):
    ...
    for vid in data.keys():
        ...
        label = np.zeros((CLASSES, num_frames), np.float32)
...
class Dataset(data_utl.Dataset):
    ...
    def __getitem__(self, index):
        ...
        imgs = load_rgb_frames_from_video(ROOT, vid, start_f, total_frames)
